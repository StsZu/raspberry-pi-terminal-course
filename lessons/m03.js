  ...
  lessons: [
    {
      ...
      steps: [
        { type: "story", title: "Потрібен git — де його взяти?",
          body: "<p>Ти хочеш клонувати проєкт з GitHub, а Pi відповідає <code>git: command not found</code>. На Mac ти б пішов у App Store чи Homebrew, а на Raspberry Pi OS програми ставлять через <code>apt</code>.</p><p>Raspberry Pi OS збудована на Debian (Debian 12 Bookworm або новіший — залежить від версії образу), тож усе, що ти тут вивчиш, працює й на інших Debian-системах.</p>" },
        ...
        { type: "cli", title: "Оновлення системи",
          ...
          commands: [
            { cmd: "sudo apt update", explain: "Завантажує свіжі списки пакетів з репозиторіїв. Нічого не встановлює.", output: "Hit:1 http://deb.debian.org/debian bookworm InRelease\nGet:2 http://archive.raspberrypi.com/debian bookworm InRelease [39.3 kB]\nReading package lists... Done\n12 packages can be upgraded. Run 'apt list --upgradable' to see them.", risk: "low" },
        ...
        { type: "cli", title: "Знайти, дізнатись, встановити",
          commands: [
            { cmd: "apt search gpio", explain: "Шукає пакети за словом у назві й описі. Лише читає — <code>sudo</code> не потрібен.", output: "gpiod/stable 1.6.3-1+b3 arm64\n  Tools for interacting with Linux GPIO character device\npython3-gpiozero/stable 2.0.1-0+rpt1 all\n  Simple API for controlling devices attached to a Pi's GPIO pins", risk: "low" },
            { cmd: "apt show git", explain: "Опис, версія, розмір і залежності пакета перед встановленням.", risk: "low" },
            { cmd: "sudo apt install git", explain: "Встановлює пакет разом із залежностями. Якщо пакет уже є — повідомить про це.", output: "Setting up git (1:2.39.5-0+deb12u1) ...", risk: "medium" },
