  ...
  lessons: [
    {
      ...
      steps: [
        ...
        { type: "cli", title: "Що це за система",
          commands: [
            { cmd: "uname -a", explain: "Ядро Linux, його версія та архітектура. <code>aarch64</code> — 64-бітний ARM. Номер ядра змінюється з оновленнями.", output: "Linux raspberrypi 6.18.34+rpt-rpi-2712 #1 SMP PREEMPT Debian 1:6.18.34-1+rpt1 (2026-06-09) aarch64 GNU/Linux", risk: "low" },
            { cmd: "cat /etc/os-release", explain: "Версія ОС. Raspberry Pi OS показує базовий Debian: 13 (trixie) — поточний випуск; 12 (bookworm) — попередній.", output: "PRETTY_NAME=\"Debian GNU/Linux 13 (trixie)\"\nVERSION_ID=\"13\"\nVERSION_CODENAME=trixie", risk: "low" },
      ...
      quiz: [
        ...
        { question: "Яка команда покаже, чи твоя Pi вже на Trixie (Debian 13), чи ще на попередній Bookworm (Debian 12)?", options: ["`cat /etc/os-release`", "`uname -a`", "`hostname`"], correct: 0, feedback: "`/etc/os-release` містить назву й версію дистрибутива. `uname` показує ядро, а не версію ОС." },
